...
static void AddRteRelationToAttributeEquivalenceClass(AttributeEquivalenceClass **
													  ...
													  Var *varToBeAdded);
static Var * GetVarFromAssignedVar(List *outerPlanParamsList, Param *plannerParam,
											 ...
											 RelationRestriction *relationRestriction)
{
	...
	foreach(equivilanceMemberCell, plannerEqClass->ec_members)
	{
		...
		if (IsA(strippedEquivalenceExpr, Param))
		{
			...
			expressionVar =
				GetVarFromAssignedVar(relationRestriction->outerPlanParamsList,
 ...
 */
static Var *
GetVarFromAssignedVar(List *outerPlanParamsList, Param *plannerParam,
					  PlannerInfo **rootContainingVar)
{
